<template id="Menu">
  ...
  <nav class="navbar navbar-static-top">
      <div class="container-fluid m-0">
          <a class="navbar-brand mr-0" href="/admin">
              <h4 class="text-white">ADMIRE ADMIN</h4>
          </a>
                      ...
                      <div class="dropdown-menu drop_box_align" role="menu" id="messages_dropdown">
                          ...
                          <div id="messages">
                              <div class="data">
                                  <div class="row">
                                      <div class="col-2">
                                          <img src="/images/images/mailbox_imgs/5.jpg" class="message-img avatar rounded-circle" alt="avatar1"></div>
                              ...
                              <div class="data">
                                  <div class="row">
                                      <div class="col-2">
                                          <img src="/images/images/mailbox_imgs/8.jpg" class="message-img avatar rounded-circle" alt="avatar1"></div>
                              ...
                              <div class="data">
                                  <div class="row">
                                      <div class="col-2">
                                          <img src="/images/images/mailbox_imgs/7.jpg" class="message-img avatar rounded-circle" alt="avatar1"></div>
                              ...
                              <div class="data">
                                  <div class="row">
                                      <div class="col-2">
                                          <img src="/images/images/mailbox_imgs/6.jpg" class="message-img avatar rounded-circle" alt="avatar1"></div>
                                      <div class="col-10 message-data">
                      ...
                      <div class="dropdown-menu drop_box_align" role="menu">
                          ...
                          <div id="notifications">
                              <div class="data">
                                  <div class="row">
                                      <div class="col-2">
                                          <img src="/images/images/mailbox_imgs/1.jpg" class="message-img avatar rounded-circle" alt="avatar1"></div>
                                      <div class="col-10 message-data">
                              ...
                              <div class="data">
                                  <div class="row">
                                      <div class="col-2">
                                          <img src="/images/images/mailbox_imgs/2.jpg" class="message-img avatar rounded-circle" alt="avatar1"></div>
                                      <div class="col-10 message-data">
                                          <i class="fa fa-clock-o"></i>
                              ...
                              <div class="data">
                                  <div class="row">
                                      <div class="col-2">
                                          <img src="/images/images/mailbox_imgs/3.jpg" class="message-img avatar rounded-circle" alt="avatar1"></div>
                                      <div class="col-10 message-data">
                                          <i class="fa fa-clock-o"></i>
              ...
              <div class="btn-group">
                  <div class="user-settings no-bg">
                      <button type="button" class="btn btn-default no-bg micheal_btn" data-toggle="dropdown">
                          <img :src="'/images/images/admin.jpg'" class="admin_img2 rounded-circle avatar-img" alt="avatar"> <strong>Micheal</strong>
